#include<iostream>
using namespace std;
///Counting Sort - Here ,we just mark the frequency of each element in a new array ending at the max element in the array , the obtained frequency array can be transformed to a sorted array
int main()
{
    int n ,a[20] , max_no=0;
