...
{   int d , pos;
    ...
    deleteatfront(head);
    cout<<"LINKED LIST after Deletion of Front node"<<endl<<head<<endl;
    cout<<"Enter the position from where to delete the node"<<endl;
    cin>>pos;
    deleteatpos(head,pos);
    cout<<"LINKED LIST after Deletion"<<endl<<head<<endl;
